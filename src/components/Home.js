    ...
    return (
        <div className="mx-auto max-w-6xl py-32 sm:py-48 lg:py-10">
            <div className="text-left">
                <p className="mt-6 text-lg leading-8 font-semibold text-gray-600 text-justify">Hello, My name is </p>
                <h1 className='tracking-tight font-semibold text-[#f6fded] sm:text-6xl'>Hardik Patel</h1>
                <p className="mt-6 text-lg leading-8 font-semibold text-gray-600 text-justify">I'm a dedicated full-stack developer with a passion for crafting dynamic and efficient web applications. Currently, I focus on building responsive, user-friendly interfaces and robust backend systems, always aiming to deliver high-quality software solutions.</p>
                <p className="mt-6 text-lg leading-8 font-semibold text-gray-600 text-justify">
